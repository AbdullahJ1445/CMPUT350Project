...
public:
    ...
    const sc2::Unit* LocationHandler::FindNearestGasStructure(sc2::Point2D location) {
        const sc2::ObservationInterface* obs = Observation();
    ...
    const sc2::Unit* LocationHandler::FindNearestTownhall(const sc2::Point2D location) {
